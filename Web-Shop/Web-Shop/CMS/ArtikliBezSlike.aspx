<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ArtikliBezSlike.aspx.vb" Inherits="Web_Shop.ArtikliBezSlike" %>
    ...
    <div id="right-panel" class="right-panel">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Artikli bez slike</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                <%=Web_Shop.CMS.tabelaArtikalaBezSlike() %>
            </div>
        </div>
    </div>
