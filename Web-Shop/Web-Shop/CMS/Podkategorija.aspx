<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Podkategorija.aspx.vb" Inherits="Web_Shop.Podkategorija1" %>
    ...
    <div id="right-panel" class="right-panel">
            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>Podkategorije artikala IGRE.BA</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Podkategorije artikala IGRE.BA</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                <%=Web_Shop.CMS.PodKategorijeArtikala() %>
            </div>
        </div>
    </div>
