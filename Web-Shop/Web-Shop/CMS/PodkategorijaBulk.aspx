<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PodkategorijaBulk.aspx.vb" Inherits="Web_Shop.PodkategorijaBulk" %>
...
<body>
    ...
    <div id="right-panel" class="right-panel">
            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>Podkategorije artikala BULK.BA</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Podkategorije artikala BULK.BA</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
            <div class="animated">
                <%=Web_Shop.CMS.PodKategorijeArtikalaBulk() %>
            </div>
        </div>
    </div>
