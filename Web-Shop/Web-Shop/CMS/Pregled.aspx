<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Pregled.aspx.vb" Inherits="Web_Shop.Pregled" %>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Pregled članaka</li>
                        </ol>
                    </div>
                </div>
            </div>
