...
Public Class KategorijaStatusComTrade
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Using konekcija As New SqlConnection(putanja)
            ...
            Using komanda As New SqlCommand()
                ...
                If status = 1 Then
                    komanda.CommandText = "UPDATE ArtikliGrupeComTrade SET Aktivno=@Status WHERE ID=@ID;"
                Else
                    komanda.Parameters.AddWithValue("@SkladisteID", 2)
                    komanda.CommandText = "UPDATE ArtikliGrupeComTrade SET Aktivno=@Status WHERE ID=@ID; UPDATE Artikli SET Aktivno='0' WHERE GrupaID=@grpuni AND SkladisteID=@SkladisteID;"
                End If
