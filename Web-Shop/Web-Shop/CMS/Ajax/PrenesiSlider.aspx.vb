...
Public Class PrenesiSlider
    ...
    Private Sub umetniSliku()
        ...
        If Request.Files.Count > 0 Then
            ...
            Dim zadaniThumb = "1170" 'ConfigurationManager.AppSettings("NovaSirinaSlike")
            Dim i As Integer
            Dim datoteke As New List(Of Datoteka)()
            Dim folderThumb As String = "/Datoteke/Slider/Thumb/"
            Dim folderPreview As String = "/Datoteke/Slider/"
    ...
    Private Shared Function Thumb(image As Image, sirina As Integer, visina As Integer, putanja As String, selekcija As Rectangle) As Size
        ...
        Using bitmap As New Bitmap(sirina, visina)
            Using graphics As Graphics = graphics.FromImage(bitmap)
                ...
                If selekcija.Width > 0 Then
                    putanja = putanja.Replace("/Datoteke/Slider/", String.Format("/Datoteke/Slider/{0}x{1}", sirina, visina))
