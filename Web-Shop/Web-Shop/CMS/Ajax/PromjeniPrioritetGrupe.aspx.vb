...
Public Class PromjeniPrioritetGrupe
        ...
        Using konekcija As New SqlConnection(putanja)
            ...
            Using komanda As New SqlCommand()
                ...
                If prioritet + vrijednost > 0 Then
                    komanda.CommandText = "UPDATE ArtikliGrupe SET Prioritet=Prioritet-@Vrijednost WHERE NadgrupaID=@NadgrupaID AND Prioritet=@Prioritet+@Vrijednost; UPDATE ArtikliGrupe SET Prioritet=@PrioritetNovi WHERE ID=@ID;"
                    komanda.ExecuteNonQuery()
                    Dim podaci As String = CMS.PodKategorijeMrezaTablica(nadgrupa)
