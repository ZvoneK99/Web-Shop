<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="UniExpertKategorije.aspx.vb" Inherits="Web_Shop.UniExpertKategorije" %>
    ...
    <div id="right-panel" class="right-panel">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">UniExpert Kategorije</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                <%=Web_Shop.CMS.UniExpertKategorije() %>
            </div>
        </div>
    </div>
