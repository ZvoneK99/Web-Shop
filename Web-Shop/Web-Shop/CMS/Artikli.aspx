<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Artikli.aspx.vb" Inherits="Web_Shop.Artikli" %>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Aktivni artikli</li>
                        </ol>
                    </div>
                </div>
            </div>
