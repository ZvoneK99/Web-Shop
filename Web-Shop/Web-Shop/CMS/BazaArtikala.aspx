<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BazaArtikala.aspx.vb" Inherits="Web_Shop.BazaArtikala" %>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Baza artikala</li>
                        </ol>
                    </div>
                </div>
            </div>
