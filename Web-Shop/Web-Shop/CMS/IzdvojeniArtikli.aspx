<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="IzdvojeniArtikli.aspx.vb" Inherits="Web_Shop.IzdvojeniArtikli" %>
    ...
    <div id="right-panel" class="right-panel">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Izdvojeni artikli</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                <%=Web_Shop.CMS.tabelaIzdvojenihArtikala() %>
            </div>
        </div>
    </div>
