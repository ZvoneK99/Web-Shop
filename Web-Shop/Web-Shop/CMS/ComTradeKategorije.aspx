<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ComTradeKategorije.aspx.vb" Inherits="Web_Shop.ComTradeKategorije" %>
    ...
    <div id="right-panel" class="right-panel">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">ComTrade Kategorije</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                <%=Web_Shop.CMS.ComTradeKategorije() %>
            </div>
        </div>
    </div>
