...
Public Class UploadSlikeClanka
    Inherits System.Web.UI.Page

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Dim ClanakID As Integer = Request.QueryString("id")
        Dim Tag As String = Request.QueryString("tag")
        umetniSliku(ClanakID, Tag)
        Response.Redirect("Clanak.aspx?id=" & ClanakID)
    End Sub

    Private Sub umetniSliku(ClanakID As Integer, Tag As String)
        ...
        If Request.Files.Count > 0 Then
            ...
            Dim folderThumb As String = "/Datoteke/Novosti/Thumb/"
            Dim folderPreview As String = "/Datoteke/Novosti/"
            ...
            For i = 0 To Request.Files.Count - 1
                ...
                Dim naziv As String = OcistiNazivDatoteke(datoteka.FileName, ClanakID)
    ...
    Private Sub SpremuuBazu(naziv As String, ClanakID As Integer, Tag As String)
        ...
        InsertKomanda.CommandText = "UPDATE NovostiSlike SET Zadana='0' WHERE NovostID=" & ClanakID & "; INSERT INTO NovostiSlike (Datoteka, NovostID, Zadana) Values ('" & naziv & "', " & ClanakID & ", '1'); INSERT INTO BazaSlika (Datoteka, MetaTag) Values ('" & naziv & "', '" & Tag & "')"
        konekcija.Open()
        InsertKomanda.ExecuteNonQuery()
        konekcija.Close()
    End Sub

    Private Function OcistiNazivDatoteke(naziv As String, ClanakID As Integer) As String
        naziv = naziv.ToLower()
