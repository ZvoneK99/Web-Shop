<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GrupeBulk.aspx.vb" Inherits="Web_Shop.GrupeBulk" %>
...
<body>
    ...
    <div id="right-panel" class="right-panel">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Kategorije artikala BULK.BA</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
            <div class="animated">
                <%=Web_Shop.CMS.GrupeArtikalaBulk() %>
            </div>
        </div>
    </div>
